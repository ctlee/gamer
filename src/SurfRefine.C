...
void SurfaceMeshOld::refine()
{
    ...
    for (n = 0; n < nv; n++)
    {
        surfmesh_refine->vertex[n].x = vertex[n].x;
        surfmesh_refine->vertex[n].y = vertex[n].y;
        surfmesh_refine->vertex[n].z = vertex[n].z;
    }

    for (n = 0; n < num_faces; n++)
    {
        surfmesh_refine->face[n].a = face[n].a;
        surfmesh_refine->face[n].b = face[n].b;
        surfmesh_refine->face[n].c = face[n].c;
    }
    ...
    num_faces    = surfmesh_refine->num_faces;
    vertex       = surfmesh_refine->vertex;
    face         = surfmesh_refine->face;
